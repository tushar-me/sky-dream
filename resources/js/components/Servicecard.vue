<template>
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
            <RouterLink to="/Service-Details">
                <h5 class="mb-5 text-2xl font-bold text-center bg-gradient-to-b from-thirdColor to-fourthColor text-transparent bg-clip-text">HDB HOUSE</h5>
            </RouterLink>
            <p class="mb-3 font-normal text-gray-600">HDB house painting service involves repainting the interior of an HDB flat in Singapore. This can be done for a variety of reasons, such as refreshing the look of the flat.</p>
        </div>
    </div>
</template>
