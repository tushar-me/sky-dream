...
<template>
    <GuestLayout>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full">
                        <div class="flex justify-start items-center gap-3">
                            <p class="uppercase text-white font-bold text-sm md:text-xl">{{
                                    headerSettings?.hero?.prefix
                                }}</p>
                            <hr class="w-24 text-white border-2">
                        </div>
                        <h1 class="uppercase text-2xl md:text-5xl tracking-wide font-bold text-white py-4 md:py-10">
                            {{ headerSettings?.hero?.title }}</h1>
                        <p class="font-normal text-md text-white max-w-lg">{{ headerSettings?.hero?.slogan }}</p>
                        <div class="flex w-full flex-col md:flex-row items-center md:gap-5 py-10">
                            <RouterLink to="/Contact"
                                        class="uppercase w-full md:w-auto flex justify-center items-center gap-3 font-semibold my-3 bg-primary text-white border-primary px-3 py-3.5  hover:bg-teal-600 transition-all disabled:bg-teal-400 ease-in-out duration-500">
                                <Icon name="material-symbols:arrow-outward" class=" text-2xl text-white "/>
                                discover More
                            </RouterLink>
                            <RouterLink to="/all-services"
                                        class="uppercase w-full  md:w-auto  flex justify-center items-center gap-3 text-primary bg-white border-2 border-primary py-3 px-5 font-semibold group-hover:text-fourthColor transition-all ease-in-out duration-500">
                                <Icon name="material-symbols:arrow-outward"
                                      class=" text-2xl text-primary group-hover:text-fourthColor transition-all ease-in-out duration-500"/>
                                Our Services
                            </RouterLink>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap">
                        <div class="w-full lg:w-1/2 p-2" v-for="item in services?.selectedServices">
                            <div class="relative w-full overflow-hidden group transition-all ease-in-out duration-1000">
                                <div
                                    class="absolute z-10 p-5 w-full h-full top-0 bottom-0 right-0 left-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-all ease-in-out duration-700">
                                ...
                                <img
                                    class="w-full h-full object-cover group-hover:scale-110 transition-all ease-in-out duration-500"
                                    :src="item?.image" alt="">
                            </div>
                        </div>
                    </div>
        ...
        <section class="bg-[url(https://img.freepik.com/free-photo/top-view-blue-paint-brush-strokes-surface_23-2148815435.jpg?t=st=1719739976~exp=1719743576~hmac=202788a852e75aba7d7452d5467f5aa72e00e2838d46b748dd3e12461dbd4cf2&w=740)]
                ...
                <div class="w-full h-screen mb-10 flex justify-start items-center relative z-30">
                    <div class="w-full md:w-1/2">
                        <div class="w-full">
                            ...
                            <h1 class="text-2xl md:text-5xl text-white tracking-widest leading-1 font-bold my-10">Get A
                                Free Consultation Contact Us <span class="text-amber-600">!</span></h1>
                            <div class="flex justify-start items-center gap-5 my-10">
                                <RouterLink to="/Contact" class="group">
                                    <button
                                        class="uppercase flex justify-center items-center gap-3 text-primary bg-white py-3 px-5 font-semibold group-hover:text-fourthColor transition-all ease-in-out duration-500">
                                        <Icon name="material-symbols:arrow-outward"
                                              class=" text-2xl text-primary group-hover:text-fourthColor transition-all ease-in-out duration-500"/>
                                        Contact us
                                    </button>
                    ...
                    <div class="w-1/2 hidden md:block">
                        <div class="w-full h-full">
                            <img
                                src="https://img.freepik.com/free-photo/man-working-wall-with-paint-roller_23-2148384435.jpg?t=st=1719746200~exp=1719749800~hmac=2d0cb6fe9ad18923ed8cdda8b8f7bba0077f7098ecad4ea48a44bde2018961b9&w=740"
                                alt="">
                        </div>
                    </div>
                </div>
            ...
            <div
                class="container bg-sky-gradient text-center py-16 mx-10 -mt-40 relative z-40 flex justify-center items-center">
                <div class="w-1/4">
                    <h1 class="font-bold text-xl md:text-6xl text-white">{{
                            headerSettings?.counter?.project_complate
                        }}</h1>
                    <p class="text-xs md:text-xl text-white font-normal">Project Completed</p>
                </div>
                <div class="w-1/4">
                    <h1 class="font-bold text-xl md:text-6xl  text-white">{{
                            headerSettings?.counter?.customer_satisfied
                        }}</h1>
                    <p class="text-xs md:text-xl text-white font-normal">Customer Satisfied</p>
                </div>
                <div class="w-1/4">
                    <h1 class="font-bold text-xl md:text-6xl  text-white">{{
                            headerSettings?.counter?.expart_team
                        }}</h1>
        ...
        <div class="bg-[url('https://dtpainting.wpenginepowered.com/wp-content/uploads/2016/03/flower-parallax-color.png?fbclid=IwZXh0bgNhZW0CMTAAAR2CoaBVw7vs8DwY2hoDfss8yGWStybP4VoToZSB4tJDgY1V1IZaOexRcTo_aem_mdQvljFZEEFNrlWUqGKxYg')]
            ...
            <div class="absolute h-full w-full top-0 bottom-0 left-0 right-0">
                <img class="w-full h-full"
                     src="https://dtpainting.wpenginepowered.com/wp-content/uploads/2016/03/flower-parallax-grey.png?fbclid=IwZXh0bgNhZW0CMTAAAR2R6HLrWcpGd_Xdkha5UL4cRopey5PUS1f5hdHGlVBGInV4BlEHK5lpMuc_aem_Y588DKiJ-DsdFMQfuLNyJg"
                     alt="">
            </div>
            ...
            <div
                class="container mx-auto grid grid-cols-1 lg:grid-cols-4 relative z-30 justify-items-center gap-10 pt-10">
                ...
                <div class="flex items-center lg:pl-20">
                    <div class="w-full lg:w-1/2">
                        <form @submit.prevent="handelContact" class="p-5 lg:px-16">
                            ...
                            <h1 class="text-3xl gradient-text py-2 font-medium">Have An Upcoming Projects? Let’s Talk to
                                Now!</h1>
                            <div class="w-full flex gap-2 my-5">
                                <div class="w-1/2 ">
                                    <input type="text" v-model="createContact.firstname" :disabled="loading"
                                           placeholder="First Name"
                                           class=" w-full bg-gray-100 text-gray-700 border disabled:bg-gray-200 border-gray-300 placeholder:text-sm rounded">
                                    <span class="text-red-500" v-if="error?.response?.data?.errors?.firstname">{{
                                            error?.response?.data?.errors?.firstname[0]
                                        }}</span>
                                </div>
                                <div class="w-1/2">
                                    <input type="text" v-model="createContact.lastname" :disabled="loading"
                            ...
                            <div class="w-full flex gap-2 my-5">
                                <div class="w-1/2 ">
                                    <input type="number" v-model="createContact.phone" :disabled="loading"
                                           placeholder="Phone"
                                           class=" w-full bg-gray-100 text-gray-700 disabled:bg-gray-200 border border-gray-300 placeholder:text-sm rounded">
                                ...
                                <div class="w-1/2">
                                    <input type="email" v-model="createContact.email" :disabled="loading"
                                           placeholder="E-mail"
                                           class=" w-full bg-gray-100 text-gray-700 border disabled:bg-gray-200  border-gray-300 placeholder:text-sm rounded">
                            ...
                            <div class=" ">
                                <textarea v-model="createContact.message" :disabled="loading" id=""
                                          placeholder="Message" rows="5"
                                          class="w-full bg-gray-100 text-gray-700 border disabled:bg-gray-200 border-gray-300"></textarea>
                                <span class="text-red-500" v-if="error?.response?.data?.errors?.message">{{
                                        error?.response?.data?.errors?.message[0]
                                    }}</span>
                            </div>
                            <LoadingButton :isLoading="loading" class="w-full text-center">Submit Your Queries
                            </LoadingButton>
